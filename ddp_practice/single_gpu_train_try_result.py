...
"""
    내가 직접 연습해 본 결과물
    오히려 시간이 너무 늘어나는 결과가 나옴
    이유는 cpu에서 gpu로 올리는 시간이 더 오래 걸린다 -> gpu가 다음 데이터를 받을때까지 너무 놀고있다
    single_gpu_train_result로 가면 개선 버전이 있음
"""
...
def load_data(batch_size):
    ...
    # batchsampler 를 사용해서 배치를 구성하고 마지막 배치를 버림
