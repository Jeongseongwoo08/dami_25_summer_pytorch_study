...
def main(cfg: MainConfig):     
    ...
    config = AutoConfig.from_pretrained(cfg.base.model_name)
    config.max_position_embeddings = cfg.base.max_length 
    config.use_cache = False 
    config.tie_word_embeddings = False
    
    if hasattr(config, "sliding_window"):
        config.sliding_window = cfg.base.max_length 
    ...
    process_data_fn = get_preprocess_function(tokenizer, cfg.base.max_length)
